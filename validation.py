...
def validation():
    ...
    # File <timestep> of the 3D fields, file 2*<timestep> of the 2D ones.
    n = timestep
    m = 2*n
    ...
    fi0 = xr.open_dataset(basedir + 'CLCONV_2D_icon_tropic_' + m + '.nc')
    ...
    fi2 = xr.open_dataset(basedir + 'CLCONV_3D_icon_tropic_' + n + '.nc')
    ...
    fi3 = xr.open_dataset(basedir + 'WINDTH_3D_icon_tropic_' + n + '.nc')
    ...
    fi4 = xr.open_dataset(basedir + 'RAD_2D_icon_tropic_' + m + '.nc')
    ...
    with open('rrtm_inputs2test.txt','w') as f:
         for val in inputs:
             for elem in val:
                 f.write(str(elem) + ' ')
             f.write('\n')
    ...
    fi5 = xr.open_dataset(basedir + 'RAD_3D_icon_tropic_' + n + '.nc')
