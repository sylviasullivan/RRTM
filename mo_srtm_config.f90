...
! << sylvia_20200319
  MODULE mo_srtm_config
    ...
    INTEGER,  PARAMETER :: &
      ...
      ! >> sylvia_20200319
      ! Commenting out the unused line below.
...
! >> sylvia_20200319
! Commenting out the unused values below (temporarily?)
...
! << sylvia_20200319
    ...
    ! >> sylvia_20200319
    ! Commenting the unused variables out below.
